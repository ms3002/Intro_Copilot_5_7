            ...
            <div class="participants-section">
              ...
              <ul class="participants-list">
                          ${details.participants
                            .map(
                              (participant) =>
                                `<li class="participant-item"><span class="participant-email">${participant}</span> <button class="delete-btn" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(participant)}" title="Remove participant">✖</button></li>`
                            )
                            .join("")}
              </ul>
            </div>
        ...
        btn.addEventListener('click', async (e) => {
          ...
          try {
            ...
            if (resp.ok) {
              ...
              // Re-fetch activities to keep counts accurate
              fetchActivities();
            } else {
